...
class ApiCorona {
  ...
  async getCountryAnalytics(countryCode, date) {
    return axios.get(
      `https://api.coronatracker.com/v3/analytics/trend/country?countryCode=${countryCode}&startDate=2020-03-22&endDate=2020-03-${date}`,
    );
  }
  /*
   * travel alert
